...
class RiskAnalysisResponse(BaseModel):
    ...
    heatmapRiskPhase: Dict[str, Any] = Field(..., description="Risk pattern heatmap grouped by category and factor")
    sectorMinistryHeatmap: List[SectorMinistryHeatmapItem] = Field(..., description="Risk count per sector per risk category")
